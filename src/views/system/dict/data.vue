<template>
  <div class="app-container">
    <el-form class="queryParent" :model="queryParams" ref="queryForm" label-width="80px">
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" :close-on-click-modal="false" :append-to-body="true">
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="显示排序" prop="dictSort">
          <el-input-number v-model.trim="form.dictSort" controls-position="right" :min="0" :max="999"/>
        </el-form-item>
        <el-form-item label="状态" prop="status">
        ...
        <el-form-item label="备注" prop="remark">
          <el-input v-model="form.remark" maxlength="500" show-word-limit type="textarea" placeholder="请输入内容"></el-input>
        </el-form-item>
      </el-form>
    ...
    return {
      ...
      rules: {
        dictLabel: [
          ...
          { max: 50, message: '字典标签最多输入50个字符' }
        ],
        dictValue: [
          { required: true, message: "字典键值不能为空", trigger: "blur" },
          { max: 50, message: '字典键值最多输入50个字符' }
        ],
        dictSort: [
