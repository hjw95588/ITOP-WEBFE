<template>
  <div class="app-container">
    <el-form :model="queryParams" class="queryParent" ref="queryForm" label-width="80px" v-show="showSearch">
      <el-form-item label="岗位编码" prop="postCode" class="el-item-two ">
        <el-input
      ...
      <el-form-item label="岗位名称" prop="postName" class="el-item-two">
        <el-input
      ...
      <el-form-item label="状态" prop="status" v-show="controlPostQuery">
    ...
    <div class="dataWrap">
      ...
      <el-table v-loading="loading" :data="postList" @selection-change="handleSelectionChange">
        ...
        <el-table-column label="岗位名称" align="center" prop="postName" v-if="columns[0].visible"/>
        <el-table-column label="岗位编码" align="center" prop="postCode" v-if="columns[1].visible"/>
        <el-table-column label="岗位排序" align="center" prop="postSort" v-if="columns[2].visible"/>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" :close-on-click-modal="false" :append-to-body="true">
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="岗位顺序" prop="postSort">
          <el-input-number v-model="form.postSort" controls-position="right" :min="0" :max="999" />
        </el-form-item>
    ...
    return {
      ...
      rules: {
        postName: [
          ...
          { max: 50, message: '岗位名称最多输入50个字符' }
        ],
        postCode: [
          { required: true, message: "岗位编码不能为空", trigger: "blur" },
          { max: 64, message: '岗位名称最多输入64个字符' }
        ],
        postSort: [
