      ...
      <div class="container-info">
        ...
        <div v-loading="listLoading" class="content-container">
          ...
          >
            ...
            <el-table-column align="center" :label="$t('processList.action')" width="150" class-name="small-padding fixed-width">
              <template slot-scope="scope">
                <el-row>
                  <el-col :span="24">
        ...
        <div class="page-footer">
          <pagination  :total="total" :page.sync="searchObject.pageIndex" :limit.sync="searchObject.pageSize" style="float:right;" @pagination="queryList" />
        </div>
      </div>
    </div>
  </div>
...
<script>
// import { getList, updateDefaultVersion } from '@/api/processDetail'
