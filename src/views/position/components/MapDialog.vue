<template>
  <div>
    <el-dialog title="定位设置" :visible.sync="mapVisible"
               :before-close="close"   id="mapDialog" width="65%" top="8vh"
...
import logo from '@/assets/logo/map.png'
export default {
  name: "mapDialog",
  components: {
    BaiduMap,
  ...
  data () {
    return {
      center: {lng: 116.40476, lat: 39.912696},
      zoom: 12,
      locData:{
        longitude:'',
        latitude:'',
  ...
  methods: {
    ...
    clickEvent(e){
      map.clearOverlays();
      let Icon_0 = new BMap.Icon(this.iconUrl, new BMap.Size(64, 64), {anchor: new BMap.Size(18, 32),imageSize: new BMap.Size(36, 36)});
    ...
    getLoctionSuccess(point, AddressComponent, marker){
      map.clearOverlays();
      let Icon_0 = new BMap.Icon(this.iconUrl,
        new BMap.Size(64, 64), {anchor: new BMap.Size(18, 32),imageSize: new BMap.Size(36, 36)});
          ...
          if (local.getResults() != undefined) {
            ...
            if (local.getResults().getPoi(0)) {
              ...
              geoc.getLocation(point, function(rs) {
                var addComp = rs.addressComponents;
                that.$set(that.locData,'address',addComp.province +  addComp.city +
